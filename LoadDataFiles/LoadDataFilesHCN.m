...
CollisionRates_HCN_H2 = CollisionRatesReaderLamdaFormat.CreateCollisionRatesFromFile('DataFiles/Lamda/hcn@xpol.dat',CollisionPartnersCodes.H2,MoleculeData_HCN,collisionRateRatio);